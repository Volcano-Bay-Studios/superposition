...
public class SuperpositionMessages {
    ...
    public static void register() {
        ...
        INSTANCE.registerClientbound(BlockDataSyncS2CPacket.TYPE, BlockDataSyncS2CPacket.CODEC, SuperpositionClientPacketHandler::handleBlockSync);
        ...
        INSTANCE.registerServerbound(ChangeWidgetC2SPacket.TYPE, ChangeWidgetC2SPacket.CODEC, SuperpositionServerPacketHandler::handleChangeWidget);
    }
