...
public class SuperpositionBlocks {
    ...
    private static <T extends Block> RegistrySupplier<T> registerBlock(String name, T block) {
        RegistrySupplier<T> toReturn = BLOCKS.register(name, () -> block);
        SuperpositionItems.ITEMS.register(name, () -> new BlockItem(block, new Item.Properties().arch$tab(SuperpositionTabs.TAB)));
        return toReturn;
    }
}
