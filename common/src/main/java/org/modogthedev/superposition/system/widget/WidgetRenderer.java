...
public class WidgetRenderer<T extends Widget> {
    ...
    public void render(T widget, @NotNull BlockState state, float pPartialTick, PoseStack ms, MultiBufferSource bufferSource, int light, int pPackedOverlay, Color color) {

    }

    public void renderPartial(PartialModel model, @NotNull BlockState state, PoseStack ps, VertexConsumer buffer, int light, Color color) {
